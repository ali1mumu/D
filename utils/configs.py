...
def parse(args=None):
    ...
    parser.add_argument('--input_res', '-res', type=int, default=64,
                        help='Resolution for spherical inputs; may subsample if larger')   # 球面输入的分辨率；如果较大，可以进行二次采样
    ...
    parser.add_argument('--training_epoch', '-ne', type=int, default=1,
    ...
    parser.add_argument('--test_epoch', type=int,
                        default=1, help='Epoch for test') # 30
