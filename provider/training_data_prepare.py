...
sym_id = [0,1,3]
# DATA_DIR = 'data'
# DATA_DIR=sys.path.append(os.path.join(ROOT_DIR, '..', 'data'))
ta_main=os.path.abspath(os.path.dirname(os.path.dirname(__file__)))
DATA_DIR=os.path.join(ta_main, 'data_1')
